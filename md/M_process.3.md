...
<b>use</b> M_process, <i>only</i> : streampointer, <i>
</pre>
      ...
      <blockquote>
        <table cellpadding="3">
          ...
          <tr valign="top">
            ...
            <td valign="bottom">
              error flag returned. zero (0) indicates no error was detected.
	      The meaning of non-zero values can vary from system to system.
	      Typically
	      <br/><i>process_openread</i>(3f)  : negative indicates an error
	      <br/><i>process_openwrite</i>(3f) : negative indicates an error
	      <br/><i>process_writeline</i>(3f) : negative indicates an error
              <br/><i>process_readline</i>(3f)  : Non-zero indicates an error
              <br/><i>process_close</i>(3f)     : Non-zero indicates an error
             </td>
          </tr>
